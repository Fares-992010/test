...
function productDataUpdateModel (id){
    ...
    Updateprice.value = products[id].price + "  EGP"
    UpdateId.value = id
...
updateform.addEventListener("submit",(e)=>{
    ...
    immmg = updateImg.files[0].name

    var data={pname:UpdateName.value,price:Updateprice.value,des:UpdateDesc.value,img:immmg};
